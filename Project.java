...
public class Project {
	    ...
	    public static void main(String[] args) {
	    	List<String> wordss = new ArrayList<String>();
	    	wordss.add("hello"); wordss.add("computer");wordss.add("male");
	        wordss.add("sound");wordss.add("zebra");
	    ...
	    public static int findEmptyPosition(char[] enteredLetters) {
	        ...
	        for(int x = 0; x < enteredLetters.length; x++)
	        {
	            if((int)enteredLetters[i] != 0)
	            {
	                i++;
	            }
	        }
